 ...
 * @author David
 */
public class jFrameResponsable extends javax.swing.JInternalFrame {
    ...
    public jFrameResponsable() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
    ...
    private void initComponents() {
        ...
        jlabelTitle1.setText("REGISTRO DE RESPONSABLE");
        ...
        panelShadow1Layout.setHorizontalGroup(
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(jlblCardheader, javax.swing.GroupLayout.PREFERRED_SIZE, 424, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelShadow1Layout.createSequentialGroup()
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        try {
            ...
            boolean existeRegistro = Ctr_Responsable.verificarCarnetRegistrado(carnet);

            if (existeRegistro) {
                int rst = Ctr_Responsable.borrarRegistro(
                        carnet,
                        Estado()
                );
                if (rst > 0) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if (this.Validacion()) {
            try {
                ...
                if (existeRegistro) {
                    int rst = Ctr_Responsable.actualizar(carnet,
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (ValidacionBusqueda() == true) {
            try {
                ...
                Responsable p = Ctr_Responsable.leerRegistro(val);
        ...
        if (this.Validacion()) {
            try {
                ...
                if (existeCustodio) {
                    ...
                    JOptionPane.showMessageDialog(this, "Este registro ya existe como Instructor",
                            "Registro no grabado", JOptionPane.ERROR_MESSAGE);
                } else {

                    if (!existeResponsable) {
                        int rst = Ctr_Responsable.agregar(
    ...
    private void jTableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDataMouseClicked
        try {
            ...
            Responsable p = Ctr_Responsable.leerRegistro(inss);
    ...
    private void cargarTabla(int page) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        Ctr_Responsable obb = new Ctr_Responsable();
