...
import controlador.CTr_DetalleMovEqMob;
 ...
 * @author David
 */
public class jFrameMovimientoEquipoMob extends javax.swing.JInternalFrame {
    ...
    public jFrameMovimientoEquipoMob() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlabelTitle1.setText("MOVIMIENTOS DE EQUIPO MOBILIARIO");
        ...
        panelShadow1Layout.setHorizontalGroup(
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        .addComponent(jlblCarnet1, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30)
                        .addComponent(jtxtResponsable, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
        ...
        panelShadow1Layout.setVerticalGroup(
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDateEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtObservacion, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtxtArt, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void lblBuscarEquipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarEquipoMouseClicked
        try {
            ...
            if (p != null) {
                ...
                Movimiento p2 = CTr_Movimientos.leerEquipoMobiliario(numArt);
                if (p2 != null) {
        ...
        if (this.Validacion()) {
            try {
                ...
                int rst = CTr_Movimientos.agregar(Integer.parseInt(this.jtxtCarnet1.getText()) + 1,
                        ...
                        this.txtObservacion.getText(),
                        this.txtDateEntrada.getText()
                );
                int rst2 = CTr_DetalleMovEqMob.agregar(Integer.parseInt(this.jtxtCarnet1.getText()) + 1,
                        CTr_DetalleInvEqMobiliario.buscarIDEquipo(Integer.parseInt(this.jtxtNumArt.getText())));
                if (rst > 0 && rst2 > 0) {
    ...
    private void jTableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDataMouseClicked
        ...
        try {
            ...
            Movimiento p = CTr_Movimientos.leerMovimientoMob(numInventario);
    ...
    private void cargarTabla(int page) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        if (jtxtArt.getText().isEmpty()) {
            ...
            CTr_Movimientos obb = new CTr_Movimientos();
            filasResultantes = obb.ListarMovimientosEquipoMob(Integer.parseInt(jtxtArt.getText()));
        }
