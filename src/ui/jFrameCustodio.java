 ...
 * @author David
 */
public class jFrameCustodio extends javax.swing.JInternalFrame {
    ...
    public jFrameCustodio() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlabelTitle1.setText("REGISTRO DE CUSTODIO");
        ...
        btnBorrar2.setBackground(new java.awt.Color(82, 183, 136));
        btnBorrar2.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 10)); // NOI18N
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
                        .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jlblCardheader, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(panelShadow1Layout.createSequentialGroup()
                                .addGap(26, 26, 26)
                    ...
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        ...
                        .addGap(45, 45, 45)
                        .addComponent(jtxtCarnet, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(40, 40, 40)
                    ...
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnBorrar2, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(panelShadow1Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelShadow1Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(btnBorrar2, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnBorrar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrar2ActionPerformed
        ...
        try {
            ...
            int inss = Integer.parseInt(this.jtxtCarnet.getText());
            boolean existeRegistro = CTr_Custodio.verificarInssRegistrado(inss);

            if (existeRegistro) {
                int rst = CTr_Custodio.borrarRegistro(
                        inss,
                        Estado()
                );
                if (rst > 0) {
            ...
            else // De lo contrario no existe
            {
                JOptionPane.showMessageDialog(null, "No Exite es un nuevo registro:"
                        + String.valueOf(inss), "AcutalizarRegistro", JOptionPane.ERROR_MESSAGE);
            }// Fin
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if (this.Validacion()) {
            try {
                ...
                if (existeRegistro) {
                    int rst = CTr_Custodio.actualizar(inss,
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if (ValidacionBusqueda() == true) {
            try {
                // Realizar el filtrado de un registro indicado por el numero de carnet:
                ...
                if (p != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "No Exite el registro con el número "
                            + "de inss: "
                            + String.valueOf(Integer.parseInt(this.jtxtCarnet.getText())), "Custodio", JOptionPane.ERROR_MESSAGE);
                }
            } catch (ClassNotFoundException ex) {
                JOptionPane.showMessageDialog(this, "Error al intentar guardar "
        ...
        if (this.Validacion()) {
            try {
                ...
                if (existeResponsable) {
                    ...
                    JOptionPane.showMessageDialog(this, "Este registro ya existe como un Responsable",
                            "Registro Existente", JOptionPane.ERROR_MESSAGE);

                } else if (existeInstructor) {
                    JOptionPane.showMessageDialog(this, "Este registro ya existe como un Instructor",
                            "Registro Existente", JOptionPane.ERROR_MESSAGE);
                } else {

                    if (!existeCustodio) {
                        int rst = CTr_Custodio.agregar(
    ...
    private void jTableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDataMouseClicked
        try {
            ...
            Custodio p = CTr_Custodio.leerRegistro(inss);
    ...
    private void cargarTabla(int page) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        // Llenado
        CTr_Custodio obb = new CTr_Custodio();
